...
/**********************************************************************/
/*  Shift-JIS表示関数 - lang_euc_sjis                                 */
/* ------------------------------------------------------------------ */
/* 関数概要                                                           */
/*   文字データを、変換 [ Shift-JIS → EUC ] してから表示する。       */
/**********************************************************************/
vd  lang_euc_sjis( struct ifa_s *ifa )  /* Shift-JIS表示関数          */
{
    li           cnt ;                  /* ループカウンタ             */
    li           pos_x ;                /* X座標                      */
    li           pos_y ;                /* Y座標                      */

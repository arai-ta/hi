...
/**********************************************************************/
/*  EUC表示関数 - lang_sjis_euc                                       */
/* ------------------------------------------------------------------ */
/* 関数概要                                                           */
/*   文字データを、変換 [ EUC → Shift-JIS ] してから表示する。       */
/**********************************************************************/
vd  lang_sjis_euc( struct ifa_s *ifa )  /* EUC表示関数                */
{
    li           cnt ;                  /* ループカウンタ             */
    li           pos_x ;                /* X座標                      */
    li           pos_y ;                /* Y座標                      */
